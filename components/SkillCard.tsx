...
export function SkillCard({ unifiedSkill, onSync, viewContext }: SkillCardProps) {
    ...
    const handleCollect = async () => {
        ...
        try {
            ...
            const { actionCollectToHub } = require('@/app/actions');
        ...
        <div className={styles.card}>
            ...
            <div className={styles.content}>
                <div className="w-full">
                    ...
                    <div className={styles.badges}>
                        {unifiedSkill.instances.some(s => s.location === 'hub') && (
                            <span className={clsx(styles.badge, styles.badgePrimary)} title="Present in Central Hub">
                ...
                <div className={styles.description} title={unifiedSkill.description}>
                    ...
                    <span className="text-gray-400 select-none ml-2">*/</span>
                </div>
                ...
                <div className={styles.actions}>
                    ...
                    <button
                        ...
                        disabled={isDeleting}
                        title={viewContext.view === 'all' ? "Delete from ALL locations" : "Delete from current view"}
                    >
                        <div className="flex items-center justify-center gap-2">
